...
- Iniciales = {e}
    - Como f:{e}->M es un morfismo de monoides, debe cumplir que f(e) = e_M y por lo tanto f es única
...
TODO: dibujar diagrama y mencionar la flecha única 
