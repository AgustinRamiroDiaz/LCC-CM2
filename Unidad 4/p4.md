...
Y por ser los singuletes de x e y terminales
- $ x_f = x_g$
- $ y_f = y_g$
...
Como {} es inicial entonces {}_A y {}B son únicos y por lo tanto ({}_A, {}_B) es única

Y con el diagramita se ve que conmuta muy lindo

Como la flecha {}->{} es la identidad, 
...
a y b: categoría discreta

c: Kn conmutativo o categoría discreta de 1 solo elemento
...
Reemplazando cruzado obtenemos que (u o u') es neutro respecto a la composición y qus, (u' o u) es neutro respecto a pes.  

## 26
El conjunto vacío

Los iniciales son pullbacks si existen las flechas necesarias
