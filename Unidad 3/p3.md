...
Definimos la función f = id

f(gh) = gh = h op g = f(h) op f(g) = f(g) f(h)


b) D3 ' S3, donde D3 es el grupo de simetr ́ıas del tri ́angulo equil ́atero y S3 es el grupo de permuta-
ciones de 3 elementos.
c) D4 6' S4 pero existe un monomorfismo D4 → S4, donde D4 es el grupo de simetr ́ıas del cuadrado
y S4 es el grupo de permutaciones de 4 elementos.
