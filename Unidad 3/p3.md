...
TODO: Preguntar por qué nos hacen demostrar las 2 igualdades
...
Veamos el si la función $emb(m) = (\lambda x. m x)$ es un morfismo

Veamos que preserva la estructura

$emb(g h) = \lambda x. ghx = (\lambda x. g x) (\lambda x. h x) = (\lambda x. g x) (\lambda x. h x)$

Veamos que preserva el neutro

$emb(e) = \lambda x. ex = \lambda x. x$

TODO: Ver que es mono
