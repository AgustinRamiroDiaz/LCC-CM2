...
Supongamos que tenemos 2 funtores G:A->Sem y H:A->Sem con A \in Cat tales que
...
Entonces, con los 2 resultados anteriores obtenemos que $G(a) = H(a)$ para cualquier $a \in A$ y mostramos que el funtor F es "monomorfismo para los objetos".
