...
Id:
Sea $S \in ob(Sem)$ un semigrupo y $id_S \in Hom(S,S)$ el morfismo de semigrupo identidad de S. Notemos que $F(id_S) \in Hom(F(S), F(S))$ es un morfismo de monoide.
- Para elementos de la forma $(0, x) \in F(S)$
    - $F(id_S) (0, x)$
    - = def F
    - $(0, id_S(x))$
    - = def id_S (identidad en semigrupos)
    - $(0, x)$
    - = def $id_{F(S)}$ (identidad en monoides)
    - $id_{F(S)} (0, x)$

- Para elementos de la forma $(1, e) \in F(S)$
    - $F(id_S) (1, e)$
    - = def F
    - $(1, e)$
    - = def $id_{F(S)}$
...
- $f, g \in mor(Sem) : f:S_2 \rightarrow S_3, g:S_1 \rightarrow S_2$.
Notemos que $F(S_3) \in Mon$
- Para elementos de la forma $(0, x) \in F(S_3)$
    - $F(f \circ g) (0, x)$
    - = def F
    - = $(0, f \circ g(x))$
...
- Para elementos de la forma $(1, e) \in F(S_3)$
    - $F(f \circ g) (1, e)$
    - = def F
    - = $(1, e)$
    - = def F
...
Veamos que $G(f) = H(f) \forall f \in mor(A)$. Sabemos que:
...
Sea (0, x) un elemento arbitrario del monoide de llegada
- $F (G (f)) (0, x) = F (H (f)) (0, x)$
- $\iff$ def F
- (0, G(f) (x)) = (0, H(f) (x))
- $\iff$
...
---
Veamos que $G(a) = H(a) \forall a \in ob(A)$. Sabemos que:
