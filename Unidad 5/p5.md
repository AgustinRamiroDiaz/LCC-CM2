...
- Para elementos de la forma $(0, x) \in F(S) \in Mon$
    - $F(id_S) (0, x)$
    - = def F
    - $(0, id_S(x))$
...
- Para elementos de la forma $(1, e) \in F(S) \in Mon$
    - $F(id_S) (1, e)$
    - = def F
    - $(1, e)$
    - = def $id_{F(S)}$
...
- Para elementos de la forma $(0, x) \in F(S_3) \in Mon$
    - $F(f \circ g) (0, x)$
    - = def F
    - $(0, f \circ g(x))$
...
- Para elementos de la forma $(1, e) \in F(S_3) \in Mon$
    - $F(f \circ g) (1, e)$
    - = def F
    - = $(1, e)$
    - = def F
...
Supongamos que tenemos 2 funtores $G, H:A->Sem$ con $A \in Cat$ tales que $ F \circ G = F \circ H $
...
Veamos que pasa con el producto de 2 elementos del monoide. Sean $(0, x), (0, y) \in F \circ G (a) = F \circ H (a)$ 
